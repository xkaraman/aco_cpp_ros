...
class TurtleBot:
    ...
    def move2goal(self):
        i=0
        coordinates = [ [-0.25,-0.45] , [1.53,-3.11] ,[-0.45,-0.35] , [3.53,-4.11]]
        while True: #i < len(coordinates) :
		print ("komple3")
		"""Moves the turtle to the goal."""
		goal_pose = Pose()

		# Get the input from the user.
		goal_pose.x =coordinates [i][0]             #input("Set your x goal: ") 
		goal_pose.y =coordinates [i][1]             #input("Set your y goal: ")
